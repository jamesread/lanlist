<div class = "technowax-discord-help">
	<p>This is the <a href = "https://technowax.net">TechnoWax</a> Discord community; it supports <strong>lanlist</strong> too — you can drop in there for help with listings, your account, or general questions about the site.</p>

	<p class = "contact-discord-help"><strong>Get help via Discord:</strong>
		<a class = "organizer-platform-button organizer-platform-button--discord" href = "https://discord.gg/jhYWWpNJ3v" target = "_blank" rel = "noopener noreferrer">
			...
			<span>Join TechnoWax Discord</span>
		</a></p>
</div>
